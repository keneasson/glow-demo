          ...
          <YStack flex={6} flexDirection={'column'}>
            ...
            <YStack flexDirection={'column'} alignContent={'flex-end'}>
              <Paragraph>
                ...
                elementum eu. Placerat duis ultricies lacus sed turpis tincidunt id aliquet risus. A
                cras semper auctor neque vitae tempus quam pellentesque nec. Et pharetra pharetra
                massa massa ultricies. Posuere ac ut consequat semper viverra nam libero justo
                laoreet. Vitae congue mauris rhoncus aenean vel elit. Magna eget est lorem ipsum
                dolor sit amet consectetur. At volutpat diam ut venenatis tellus. Ornare arcu dui
                vivamus arcu. Ut faucibus pulvinar elementum integer.
              </Paragraph>
            </YStack>
          </YStack>
        </XStack>
